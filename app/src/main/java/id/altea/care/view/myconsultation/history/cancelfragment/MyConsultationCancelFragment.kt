...
class MyConsultationCancelFragment : BaseHistoryFragment<MyConsultationCancelFragmentVM>() {

    override fun setStringResCardEmptyAppointment(): Int {
        return R.string.str_cancel_empty
    }

    override fun bindViewModel(): MyConsultationCancelFragmentVM {
        return ViewModelProvider(this, viewModelFactory)[MyConsultationCancelFragmentVM::class.java]
    }
