...
class GetCancelAppointmentUseCase @Inject constructor(private val appointmentRepository: AppointmentRepository) {
    ...
    fun doRequestOnGoingAppointment(param: Param): Single<List<AppointmentData>> {
        return appointmentRepository.getCancelAppointment(
