...
public class AdvancedWebView extends WebView {
    ...
    @SuppressWarnings("static-method")
    public void setCookie(final String value1,final String value2){
        CookieManager.getInstance().setAcceptCookie(true);
        CookieManager.getInstance().setCookie(value1, value2);
    }

    @SuppressWarnings("static-method")
    public String getCookie(final String cookieName){
        return CookieManager.getInstance().getCookie(cookieName);
    }
    ...
    protected void init(Context context) {
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                return handleWebViewCustomUri(uri,url);
            }

            private boolean handleWebViewCustomUri(final Uri uri,final String url) {
